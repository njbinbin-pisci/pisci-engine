//! Headless host implementation of the piscis-core host traits.
//!
...
impl HostTools for CliHostTools {
    fn register(&self, _registry: &mut piscis_core::host::ToolRegistryHandle) {
...
impl CliHost {
    ...
    /// "no subagent runtime" errors — appropriate for the piscis-only
