...
/// signature, Piscis's harness swaps to the **full** schema for the
...
mod tests {
    ...
    fn finalize_is_a_no_op_for_simple_chat() {
        ...
        let lp = LayeredPrompt::from_monolithic("you are piscis");
    ...
    fn compute_layered_breakdown_splits_layers() {
        ...
        let minimals = HashMap::new();
        let bd = compute_layered_breakdown(&msgs, Some("you are piscis"), &tools, &minimals, 0, 0);
